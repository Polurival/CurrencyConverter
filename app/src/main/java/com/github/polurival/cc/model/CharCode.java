...
public enum CharCode {
    AED {
        ...
        public String getName() {
            return AppContext.getContext().getString(R.string.AED);
        }
    },
    ALL {
        @Override
        public String getName() {
            return AppContext.getContext().getString(R.string.ALL);
        }
    },
    AMD {
        @Override
    ...
    EEK {
        @Override
        public String getName() {
            return AppContext.getContext().getString(R.string.EEK);
        }
    },
    EGP {
        @Override
    ...
    ILS {
        @Override
        public String getName() {
            return AppContext.getContext().getString(R.string.ILS);
        }
    },
    INR {
        @Override
    ...
    IQD {
        @Override
        public String getName() {
            return AppContext.getContext().getString(R.string.IQD);
        }
    },
    IRR {
        @Override
        public String getName() {
            return AppContext.getContext().getString(R.string.IRR);
        }
    },
    ISK {
        @Override
        public String getName() {
            return AppContext.getContext().getString(R.string.ISK);
        }
    },
    ...
    JOD {
        @Override
        public String getName() {
            return AppContext.getContext().getString(R.string.JOD);
        }
    },
    JPY {
        @Override
    ...
    LTL {
        @Override
        public String getName() {
            return AppContext.getContext().getString(R.string.LTL);
        }
    },
    LVL {
        @Override
    ...
    NZD {
        @Override
        public String getName() {
            return AppContext.getContext().getString(R.string.NZD);
        }
    },
    ...
    OMR {
        @Override
        public String getName() {
            return AppContext.getContext().getString(R.string.OMR);
        }
    },
    ...
    QAR {
        @Override
        public String getName() {
            return AppContext.getContext().getString(R.string.QAR);
        }
    },
    ...
    YER {
        @Override
        public String getName() {
            return AppContext.getContext().getString(R.string.YER);
        }
    },
